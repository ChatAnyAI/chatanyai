...
import { useMediaQuery } from '@/components/editor-pro/hooks/use-media-query';
import { useMounted } from '@/components/editor-pro/hooks/use-mounted';
import { buttonVariants } from '@/components/editor-pro/potion-ui/button';
...
export const DialogModalTitle = withVariants(
...
export const DrawerOverlay = withCn(
...
export const DrawerTitle = withVariants(
  DrawerPrimitive.Title,
  dialogTitleVariants
);

export const DrawerDescription = withCn(
